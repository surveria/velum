...
pub fn is_engine262_syntax_error_reference_divergence(
    velum: &EngineOutcome,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_shared_array_buffer_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_resizable_array_buffer_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_legacy_decimal_escape_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_engine262_invalid_decimal_digits_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_engine262_invalid_identity_escape_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_legacy_control_escape_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_legacy_quantified_lookahead_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_closing_bracket_regexp_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_shared_array_buffer_zero_length_slice_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_webassembly_host_api_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_fuzzilli_introspection_reference_unstable(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_engine262_missing_annex_b_string_legacy_method(
    source: &str,
    velum: &EngineOutcome,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
...
pub fn is_annex_b_string_legacy_with_v8_rab_alignment_without_oracle(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_annex_b_string_legacy_with_unavailable_v8_fallback(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_engine262_missing_annex_b_regexp_compile_method(
    source: &str,
    velum: &EngineOutcome,
    engine262: &EngineOutcome,
) -> bool {
...
pub fn is_reference_unsupported_immutable_array_buffer_method(
    source: &str,
    velum: &EngineOutcome,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
...
pub fn is_reference_missing_immutable_array_buffer_method(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_reference_missing_date_temporal_instant_method(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_engine262_locale_validation_gap(
    source: &str,
    velum: &EngineOutcome,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
...
pub fn is_reference_unsupported_resource_management_syntax(
    source: &str,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
) -> bool {
...
pub fn is_reference_unsupported_resource_management_symbols(
    source: &str,
    velum: &EngineOutcome,
    engine262: &EngineOutcome,
    v8: &EngineOutcome,
...
pub fn references_complete_equivalently(engine262: &EngineOutcome, v8: &EngineOutcome) -> bool {
    engine262.is_completed() && v8.is_completed() && outcomes_equivalent(engine262, v8)
}

pub fn source_contains_resource_management_symbol_access(source: &str) -> bool {
...
pub fn is_engine262_missing_global(engine262: &EngineOutcome) -> bool {
    engine262.status == OutcomeStatus::JsError
...
pub fn is_engine262_missing_global_message(message: &str) -> bool {
