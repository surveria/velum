...
impl JetStreamRecord {
    fn from_run(row: &jetstream::JetStreamRow) -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            engine_median_duration_ns: measurement_duration(&row.velum_time)?,
            engine_cv_permille: optional_cv_permille(&row.velum_cv)?,
...
impl JetStreamDetailRecord {
    fn from_run(row: &jetstream::JetStreamRow) -> anyhow::Result<Self> {
        Ok(Self {
            ...
            engine_wall_duration_ns: wall_duration(&row.velum_measure)?,
