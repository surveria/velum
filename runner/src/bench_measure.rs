...
const ENV_MIN_TIME_MS: &str = "VELUM_BENCH_MIN_TIME_MS";
const ENV_WARMUP_MS: &str = "VELUM_BENCH_WARMUP_MS";
const ENV_SAMPLES: &str = "VELUM_BENCH_SAMPLES";
const ENV_MIN_OP_US: &str = "VELUM_BENCH_MIN_OP_US";
const ENV_MAX_CV_PERCENT: &str = "VELUM_BENCH_MAX_CV_PERCENT";
const ENV_ATTEMPTS: &str = "VELUM_BENCH_ATTEMPTS";
const ENV_MAX_OP_MS: &str = "VELUM_BENCH_MAX_OP_MS";
const ENV_MAX_TOTAL_MS: &str = "VELUM_BENCH_MAX_TOTAL_MS";
const ENV_JETSTREAM_MIN_TIME_MS: &str = "VELUM_JETSTREAM_MIN_TIME_MS";
const ENV_JETSTREAM_WARMUP_MS: &str = "VELUM_JETSTREAM_WARMUP_MS";
const ENV_JETSTREAM_SAMPLES: &str = "VELUM_JETSTREAM_SAMPLES";
const ENV_JETSTREAM_MIN_OP_US: &str = "VELUM_JETSTREAM_MIN_OP_US";
const ENV_JETSTREAM_MAX_CV_PERCENT: &str = "VELUM_JETSTREAM_MAX_CV_PERCENT";
const ENV_JETSTREAM_ATTEMPTS: &str = "VELUM_JETSTREAM_ATTEMPTS";
const ENV_JETSTREAM_MAX_OP_MS: &str = "VELUM_JETSTREAM_MAX_OP_MS";
const ENV_JETSTREAM_MAX_TOTAL_MS: &str = "VELUM_JETSTREAM_MAX_TOTAL_MS";
