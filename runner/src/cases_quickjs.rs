...
const PATH_QUICKJS_STRING_REGEXP_INTEROP: &str =
    "tests/corpora/quickjs_differential/active/string_regexp_interop.js";
const PATH_QUICKJS_STRING_STATIC_UNICODE_METHODS: &str =
    "tests/corpora/quickjs_differential/active/string_static_unicode_methods.js";
...
const PATH_QUICKJS_ARRAY_PROTOTYPE_GENERIC_METHODS: &str =
...
const PATH_QUICKJS_ARRAY_PROTOTYPE_SORT_COPY_METHODS: &str =
    "tests/corpora/quickjs_differential/active/array_prototype_sort_copy_methods.js";
...
const PATH_QUICKJS_GLOBAL_THIS: &str = "tests/corpora/quickjs_differential/active/global_this.js";
...
fn quickjs_object_cases() -> Vec<DifferentialCase> {
    let mut cases = vec![
        ...
        DifferentialCase {
            ...
            path: PATH_QUICKJS_PRIMITIVE_PROTOTYPE_BUILTINS,
        },
        DifferentialCase {
...
fn quickjs_array_differential_cases() -> Vec<DifferentialCase> {
    vec![
        ...
        DifferentialCase {
            id: "array_prototype_generic_methods",
            path: PATH_QUICKJS_ARRAY_PROTOTYPE_GENERIC_METHODS,
        },
        DifferentialCase {
        ...
        DifferentialCase {
            id: "array_prototype_sort_copy_methods",
            path: PATH_QUICKJS_ARRAY_PROTOTYPE_SORT_COPY_METHODS,
        },
        DifferentialCase {
...
fn quickjs_runtime_cases() -> Vec<DifferentialCase> {
    vec![
        ...
        DifferentialCase {
            ...
            path: PATH_QUICKJS_STRING_REGEXP_INTEROP,
        },
        DifferentialCase {
            id: "string_static_unicode_methods",
            path: PATH_QUICKJS_STRING_STATIC_UNICODE_METHODS,
        },
    ]
}
