...
fn failure_category(detail: &str) -> &'static str {
    ...
    if detail.starts_with(DETAIL_ASYNC_PREFIX) || detail.contains(ASYNC_HINT) {
...
mod tests {
    use super::{
        CATEGORY_HARNESS, CATEGORY_LEXER, CATEGORY_PARSER, CATEGORY_RUNTIME, case_variant,
        failure_category, failure_hint, missing_binding, test262_directory,
    };
