...
const BASELINE_SCHEMA: &str = "# velum-test262-pass-baseline-v2";
...
const UPDATE_BASELINE_ENV: &str = "VELUM_TEST262_UPDATE_PASS_BASELINE";
const PASS_CANDIDATE_PATH_ENV: &str = "VELUM_TEST262_PASS_CANDIDATE_PATH";
