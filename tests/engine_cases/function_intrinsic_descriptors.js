...
let nativeName = Object.getOwnPropertyDescriptor(TypeError, "name");
let nativeLength = Object.getOwnPropertyDescriptor(TypeError, "length");
...
print(initialName.value, initialName.configurable, initialLength.value, initialLength.configurable);
print(deletedName, hasNameAfterDelete, f.name, keysAfterName.length, keysAfterName[0]);
print(f.length, deletedLength, hasLengthAfterDelete, keysAfterLength.length, keysAfterLength[1]);
print(
    nativeName.value,
    nativeLength.value,
    assignedNativeName,
...
initialName.value === "namedCamera" &&
    ...
    nativeName.value === "TypeError" &&
    nativeLength.value === 1 &&
