...
if (!metadataOk) {
  throw new Test262Error("Math integer method metadata mismatch");
}
...
if (!clzOk) {
  throw new Test262Error("Math.clz32 result mismatch");
}
...
if (!imulOk) {
  throw new Test262Error("Math.imul result mismatch");
}
...
if (!froundOk) {
  throw new Test262Error("Math.fround result mismatch");
}
...
if (!froundTieOk) {
  throw new Test262Error("Math.fround tie result mismatch");
}
