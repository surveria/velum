...
The repository tracks a small active subset under `active/` so CI can measure progress immediately. The full upstream Test262 checkout is materialized under `target/test262` by `scripts/prepare-test262.sh` from the official Test262 repository at commit `64ff467c0c1d60c077995bb7c5f93a9d8cc8ade1`.
