...
#[test]
fn bytecode_runs_direct_active_try_catch_benchmark_body() -> TestResult {
    ...
    let source = include_str!("corpora/benchmarks/active/try_catch.js");
    ...
    ensure_at_least(direct_run_delta, 131_072, "bytecode linear direct runs")
}
