...
- Predictable embedding: expose explicit resource limits, deterministic teardown, and inspectable execution state.
- Reference-driven compatibility: use `QuickJS` behavior and Test262 subsets as compatibility references instead of inventing a new language.
- Device-oriented performance: optimize for ARM Linux systems with tens of megabytes of RAM, not desktop-only throughput.
