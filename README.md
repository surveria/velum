...
| Controlled PGO experiment | 6 training programs; 6 independent holdouts; ordinary/PGO builds | 24 valid timing rows; 144 memory workers; saved PGO binary passes all 102,578 Test262 variants and 99 `QuickJS` cases | Holdouts -34.0% time; all output checksums match; whole runner -3.9% file size | [Reviewed experiment](docs/pgo-experiment.md#reviewed-experiment-2026-09-22); one array-accounting defect fixed with 11 regression cases; one host/cohort, ordinary defaults unchanged |
