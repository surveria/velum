...
| AS-09i | asynchronous generators | draft PR #459 reuses the AS-09h detached activation owner with Promise-valued request queues, async-iterator delegation, generic thenable jobs, distinct intrinsic prototypes, typed await reactions, and native `Promise.all` aggregation; the focused async-generator profile advances from 228/1,944 to 1,900/1,944 variants and from 119/995 to 970/995 files while retaining one bytecode interpreter and the existing Promise/job accounting boundary |
