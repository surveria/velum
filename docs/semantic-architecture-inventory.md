...
| AS-09i | asynchronous generators | draft PR #459 reuses the AS-09h detached activation owner with Promise-valued request queues, async-iterator delegation, generic thenable jobs, distinct intrinsic prototypes, and typed await reactions; the focused async-generator profile advances from 228/1,944 to 1,884/1,944 variants and from 119/995 to 962/995 files while retaining one bytecode interpreter and the existing Promise/job accounting boundary |
