...
| module import live bindings | export-of-import metadata is normalized to indirect or namespace exports, recursive export resolution returns the terminal local or namespace binding, and runtime import aliases preserve both live updates and TDZ through cycles; the concrete cell and alias representation may be replaced | linking an import to another import alias, copying an exported value instead of retaining its live binding, or bypassing TDZ for a cyclic import read |
