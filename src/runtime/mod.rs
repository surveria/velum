...
pub struct Context {
    ...
    eval_binding_environments: Vec<activation::WeakEvalBindingEnvironment>,
    ...
    active_async_function_promises: Vec<PromiseId>,
...
impl Context {
    ...
    fn with_clocks(
        ...
        Self {
            ...
            eval_binding_environments: Vec::new(),
            ...
            active_async_function_promises: Vec::new(),
