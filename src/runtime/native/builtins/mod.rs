...
use super::{
    ...
    OBJECT_VALUES_NAME, PERFORMANCE_NAME, PERFORMANCE_NOW_NAME, PROMISE_ALL_NAME,
    PROMISE_CATCH_NAME, PROMISE_NAME, PROMISE_REJECT_NAME, PROMISE_RESOLVE_NAME, PROMISE_THEN_NAME,
    PROXY_REVOCABLE_NAME, REFLECT_NAME, REGEXP_NAME, REGEXP_PROTOTYPE_EXEC_NAME,
