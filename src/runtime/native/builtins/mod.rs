...
use super::{
    ...
    GLOBAL_PARSE_FLOAT_NAME, GLOBAL_PARSE_INT_NAME, JSON_NAME, JSON_PARSE_NAME,
    ...
    NUMBER_NAME, NUMBER_PROTOTYPE_TO_LOCALE_STRING_NAME, NUMBER_PROTOTYPE_TO_STRING_NAME,
    ...
    OBJECT_SEAL_NAME, OBJECT_SET_PROTOTYPE_OF_NAME, OBJECT_VALUES_NAME, PROMISE_CATCH_NAME,
