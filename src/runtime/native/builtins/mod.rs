...
use super::{
    ...
    PROMISE_THEN_NAME, PROMISE_TRY_NAME, PROMISE_WITH_RESOLVERS_NAME, PROXY_REVOCABLE_NAME,
    REFLECT_NAME, REGEXP_NAME, REGEXP_PROTOTYPE_EXEC_NAME, REGEXP_PROTOTYPE_TEST_NAME,
