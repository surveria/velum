...
use super::{
    ...
    FUNCTION_PROTOTYPE_CALL_NAME, GLOBAL_PARSE_FLOAT_NAME, GLOBAL_PARSE_INT_NAME, JSON_NAME,
    JSON_PARSE_NAME, JSON_STRINGIFY_NAME, MATH_ABS_NAME, MATH_ACOS_NAME, MATH_ACOSH_NAME,
    MATH_ASIN_NAME, MATH_ASINH_NAME, MATH_ATAN_NAME, MATH_ATAN2_NAME, MATH_ATANH_NAME,
    MATH_CBRT_NAME, MATH_CEIL_NAME, MATH_CLZ32_NAME, MATH_COS_NAME, MATH_COSH_NAME, MATH_EXP_NAME,
    MATH_EXPM1_NAME, MATH_FLOOR_NAME, MATH_FROUND_NAME, MATH_HYPOT_NAME, MATH_IMUL_NAME,
    ...
    NUMBER_IS_FINITE_NAME, NUMBER_IS_NAN_NAME, NUMBER_NAME, NativeFunctionKind, OBJECT_ASSIGN_NAME,
    ...
    REGEXP_NAME, REGEXP_PROTOTYPE_TEST_NAME, STRING_FROM_CHAR_CODE_NAME,
