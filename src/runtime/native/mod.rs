...
pub(in crate::runtime::native) use function::{
    ...
    GLOBAL_PARSE_INT_NAME, JSON_NAME, JSON_PARSE_NAME, JSON_STRINGIFY_NAME, MATH_ABS_NAME,
    ...
    MATH_SQRT_NAME, MATH_TAN_NAME, MATH_TANH_NAME, MATH_TRUNC_NAME, NUMBER_IS_FINITE_NAME,
    NUMBER_IS_INTEGER_NAME, NUMBER_IS_NAN_NAME, NUMBER_IS_SAFE_INTEGER_NAME, NUMBER_NAME,
