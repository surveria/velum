...
pub(in crate::runtime::native) use function::{
    ...
    PROMISE_ALL_NAME, PROMISE_CATCH_NAME, PROMISE_NAME, PROMISE_REJECT_NAME, PROMISE_RESOLVE_NAME,
    PROMISE_THEN_NAME, PROXY_NAME, PROXY_REVOCABLE_NAME, REFLECT_NAME, REGEXP_NAME,
