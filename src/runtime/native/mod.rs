...
pub(in crate::runtime::native) use function::{
    ...
    NUMBER_IS_SAFE_INTEGER_NAME, NUMBER_NAME, NUMBER_PROTOTYPE_TO_LOCALE_STRING_NAME,
    NUMBER_PROTOTYPE_TO_STRING_NAME, NUMBER_PROTOTYPE_VALUE_OF_NAME, OBJECT_ASSIGN_NAME,
    OBJECT_CREATE_NAME, OBJECT_DEFINE_PROPERTIES_NAME, OBJECT_DEFINE_PROPERTY_NAME,
    OBJECT_ENTRIES_NAME, OBJECT_FREEZE_NAME, OBJECT_GET_OWN_PROPERTY_DESCRIPTOR_NAME,
