...
pub(in crate::runtime::native) use function::{
    ...
    PROXY_NAME, PROXY_REVOCABLE_NAME, REFLECT_NAME, REGEXP_NAME, REGEXP_PROTOTYPE_EXEC_NAME,
    REGEXP_PROTOTYPE_TEST_NAME, REGEXP_PROTOTYPE_TO_STRING_NAME, SHARED_ARRAY_BUFFER_NAME,
