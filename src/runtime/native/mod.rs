...
pub(in crate::runtime::native) use function::{
    ARRAY_BUFFER_NAME, ARRAY_NAME, BIGINT_AS_INT_N_NAME, BIGINT_AS_UINT_N_NAME, BIGINT_NAME,
...
pub(in crate::runtime) use function::{
    ArrayBufferFunctionKind, DATA_VIEW_NAME, DATE_NAME, DATE_NOW_NAME, DATE_PARSE_NAME,
    DATE_UTC_NAME, DISPOSABLE_STACK_NAME, DataViewFunctionKind, DateFunctionKind,
    DisposableStackFunctionKind, ITERATOR_NAME, IteratorFunctionKind, NativeFunction,
    NativeFunctionKind, NativeFunctionRegistry, TypedArrayFunctionKind,
};
pub(in crate::runtime) use function::{
