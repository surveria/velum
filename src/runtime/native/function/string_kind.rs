use super::kind::{
    ...
    STRING_PROTOTYPE_TRIM_NAME, STRING_PROTOTYPE_TRIM_START_NAME, STRING_PROTOTYPE_VALUE_OF_NAME,
    STRING_RAW_NAME,
};
...
impl NativeFunctionKind {
    ...
    pub(in crate::runtime::native::function) const fn string_prototype_name(
        ...
        match self {
            ...
            Self::StringPrototypeLocaleCompare => Some(STRING_PROTOTYPE_LOCALE_COMPARE_NAME),
            Self::StringPrototypeIterator => Some(STRING_PROTOTYPE_ITERATOR_NAME),
            Self::StringPrototypeMatch => Some(STRING_PROTOTYPE_MATCH_NAME),
            Self::StringPrototypeMatchAll => Some(STRING_PROTOTYPE_MATCH_ALL_NAME),
            Self::StringPrototypeNormalize => Some(STRING_PROTOTYPE_NORMALIZE_NAME),
            Self::StringPrototypeIsWellFormed => Some(STRING_PROTOTYPE_IS_WELL_FORMED_NAME),
            ...
            Self::StringPrototypeReplaceAll => Some(STRING_PROTOTYPE_REPLACE_ALL_NAME),
            ...
            Self::StringPrototypeToWellFormed => Some(STRING_PROTOTYPE_TO_WELL_FORMED_NAME),
