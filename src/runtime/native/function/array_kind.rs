...
const ARRAY_ENTRIES_FUNCTION_LENGTH: f64 = 0.0;
...
impl NativeFunctionKind {
    pub(in crate::runtime::native::function) const fn array_length(self) -> Option<f64> {
        match self {
            ...
            Self::ArrayEntries => Some(ARRAY_ENTRIES_FUNCTION_LENGTH),
            ...
            Self::ArrayIteratorNext(_) => Some(ARRAY_ITERATOR_NEXT_FUNCTION_LENGTH),
            Self::ArrayJoin => Some(ARRAY_JOIN_FUNCTION_LENGTH),
            Self::ArrayKeys => Some(ARRAY_KEYS_FUNCTION_LENGTH),
    ...
    pub(in crate::runtime::native::function) const fn array_name(self) -> Option<&'static str> {
        match self {
            ...
            Self::ArrayIteratorNext(_) => Some(ARRAY_ITERATOR_NEXT_NAME),
