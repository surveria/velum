use super::{
    NativeFunctionKind, NativeFunctionSlot, STRING_PROTOTYPE_AT_SLOT,
    STRING_PROTOTYPE_CHAR_AT_SLOT, STRING_PROTOTYPE_CHAR_CODE_AT_SLOT,
    ...
    STRING_PROTOTYPE_VALUE_OF_SLOT,
};
