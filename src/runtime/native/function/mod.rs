...
pub(in crate::runtime::native) use kind::{
    ...
    NUMBER_IS_FINITE_NAME, NUMBER_IS_INTEGER_NAME, NUMBER_IS_NAN_NAME, NUMBER_IS_SAFE_INTEGER_NAME,
    NUMBER_NAME, OBJECT_ASSIGN_NAME, OBJECT_CREATE_NAME, OBJECT_DEFINE_PROPERTIES_NAME,
    ...
    REGEXP_PROTOTYPE_TEST_NAME, STRING_FROM_CHAR_CODE_NAME, STRING_FROM_CODE_POINT_NAME,
    ...
    STRING_PROTOTYPE_PAD_END_NAME, STRING_PROTOTYPE_PAD_START_NAME, STRING_PROTOTYPE_REPEAT_NAME,
    STRING_PROTOTYPE_SLICE_NAME, STRING_PROTOTYPE_STARTS_WITH_NAME,
...
pub(in crate::runtime::native) use primitive_kind::{
    ...
    NUMBER_PROTOTYPE_VALUE_OF_NAME, SYMBOL_PROTOTYPE_TO_STRING_NAME,
