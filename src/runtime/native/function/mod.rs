...
pub(in crate::runtime::native) use kind::{
    ...
    PROMISE_REJECT_NAME, PROMISE_RESOLVE_NAME, PROMISE_THEN_NAME, PROXY_NAME, PROXY_REVOCABLE_NAME,
...
pub(in crate::runtime::native) use primitive_kind::{
    ...
    SYMBOL_PROTOTYPE_TO_PRIMITIVE_NAME, SYMBOL_PROTOTYPE_TO_STRING_NAME,
