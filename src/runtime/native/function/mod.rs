...
pub(in crate::runtime::native) use kind::{
    ...
    GLOBAL_IS_NAN_NAME, GLOBAL_PARSE_FLOAT_NAME, GLOBAL_PARSE_INT_NAME, JSON_IS_RAW_JSON_NAME,
    JSON_NAME, JSON_PARSE_NAME, JSON_RAW_JSON_NAME, JSON_STRINGIFY_NAME, MATH_ABS_NAME,
    ...
    MATH_COS_NAME, MATH_COSH_NAME, MATH_EXP_NAME, MATH_EXPM1_NAME, MATH_F16ROUND_NAME,
    ...
    OBJECT_FREEZE_NAME, OBJECT_GET_OWN_PROPERTY_DESCRIPTOR_NAME,
    ...
    PROMISE_RESOLVE_NAME, PROMISE_THEN_NAME, REGEXP_NAME, REGEXP_PROTOTYPE_EXEC_NAME,
