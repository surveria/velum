...
pub(in crate::runtime::native) use kind::{
    ...
    PROMISE_NAME, PROMISE_REJECT_NAME, PROMISE_RESOLVE_NAME, PROMISE_THEN_NAME, PROMISE_TRY_NAME,
    PROMISE_WITH_RESOLVERS_NAME, PROXY_NAME, PROXY_REVOCABLE_NAME, REGEXP_NAME,
