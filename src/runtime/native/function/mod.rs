...
pub(in crate::runtime::native) use kind::{
    ...
    OBJECT_ASSIGN_NAME, OBJECT_CREATE_NAME, OBJECT_DEFINE_PROPERTIES_NAME,
    ...
    OBJECT_NAME, OBJECT_SET_PROTOTYPE_OF_NAME, OBJECT_VALUES_NAME, PROMISE_CATCH_NAME,
    PROMISE_NAME, PROMISE_REJECT_NAME, PROMISE_RESOLVE_NAME, PROMISE_THEN_NAME, REGEXP_NAME,
    REGEXP_PROTOTYPE_TEST_NAME, STRING_NAME, SYMBOL_NAME,
};
