...
impl NativeFunctionKind {
    ...
    const fn from_core_call_target(target: NativeCallTarget) -> Option<Self> {
        match target {
            ...
            NativeCallTarget::PromiseFinally => Some(Self::PromiseFinally),
    ...
    const fn to_core_call_target(self) -> Option<NativeCallTarget> {
        match self {
            ...
            Self::PromiseFinally => Some(NativeCallTarget::PromiseFinally),
    ...
    const fn from_string_call_target(target: NativeCallTarget) -> Self {
        match target {
            ...
            NativeCallTarget::StringPrototypeMatch => Self::StringPrototypeMatch,
            ...
            NativeCallTarget::StringPrototypeReplace => Self::StringPrototypeReplace,
            NativeCallTarget::StringPrototypeSearch => Self::StringPrototypeSearch,
            NativeCallTarget::StringPrototypeSlice => Self::StringPrototypeSlice,
            NativeCallTarget::StringPrototypeSplit => Self::StringPrototypeSplit,
    ...
    const fn to_string_call_target(self) -> Option<NativeCallTarget> {
        match self {
            ...
            Self::StringPrototypeMatch => Some(NativeCallTarget::StringPrototypeMatch),
            ...
            Self::StringPrototypeReplace => Some(NativeCallTarget::StringPrototypeReplace),
            Self::StringPrototypeSearch => Some(NativeCallTarget::StringPrototypeSearch),
            Self::StringPrototypeSlice => Some(NativeCallTarget::StringPrototypeSlice),
            Self::StringPrototypeSplit => Some(NativeCallTarget::StringPrototypeSplit),
