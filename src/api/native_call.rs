...
impl NativeCallTarget {
    ...
    fn from_string_property_name(name: &str) -> Option<Self> {
        match name {
            ...
            "match" => Some(Self::StringPrototypeMatch),
            ...
            "replace" => Some(Self::StringPrototypeReplace),
            "search" => Some(Self::StringPrototypeSearch),
            "slice" => Some(Self::StringPrototypeSlice),
            "split" => Some(Self::StringPrototypeSplit),
    ...
    fn from_math_property_name(name: &str) -> Option<Self> {
        match name {
            ...
            "f16round" => Some(Self::MathF16round),
            ...
            "sumPrecise" => Some(Self::MathSumPrecise),
    ...
    fn from_object_property_name(name: &str) -> Option<Self> {
        match name {
            ...
            "isExtensible" => Some(Self::ObjectIsExtensible),
            "isFrozen" => Some(Self::ObjectIsFrozen),
            "isSealed" => Some(Self::ObjectIsSealed),
            "keys" => Some(Self::ObjectKeys),
            "preventExtensions" => Some(Self::ObjectPreventExtensions),
            "setPrototypeOf" => Some(Self::ObjectSetPrototypeOf),
            "seal" => Some(Self::ObjectSeal),
    ...
    fn from_core_property_name(name: &str) -> Option<Self> {
        match name {
            ...
            "isInteger" => Some(Self::NumberIsInteger),
            "isNaN" => Some(Self::NumberIsNan),
            "isRawJSON" => Some(Self::JsonIsRawJson),
            "isSafeInteger" => Some(Self::NumberIsSafeInteger),
            "parse" => Some(Self::JsonParse),
            "parseFloat" => Some(Self::GlobalParseFloat),
            "parseInt" => Some(Self::GlobalParseInt),
            "rawJSON" => Some(Self::JsonRawJson),
            "reject" => Some(Self::PromiseReject),
            "resolve" => Some(Self::PromiseResolve),
            "stringify" => Some(Self::JsonStringify),
            "exec" => Some(Self::RegExpPrototypeExec),
