...
pub use crate::syntax::{
    BinaryOp, DeclKind, FunctionKind, ImportPhase, StaticBinding, StaticCallSiteId,
    StaticFunctionId, StaticName, StaticNameId, StaticPropertyAccessId, StaticString, UnaryOp,
    UpdateOp,
};
