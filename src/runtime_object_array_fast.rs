...
use super::runtime_object_array::ArrayCopyProgress;
use super::runtime_object_lookup::PrototypeTraversalBudget;
use super::{ARRAY_INDEX_LIMIT_ERROR, ArrayIndex, Object, ObjectHeap, ObjectProperty};

impl ObjectHeap {
    pub(super) fn holey_array_includes_without_indexed_prototype(
        &self,
        id: ObjectId,
        length: usize,
        search: &Value,
    ...
    pub(super) fn holey_array_index_of_without_indexed_prototype(
        &self,
        id: ObjectId,
        length: usize,
        search: &Value,
    ...
    pub(super) fn holey_array_last_index_of_without_indexed_prototype(
        &self,
        id: ObjectId,
        length: usize,
        search: &Value,
    ...
    pub(super) fn holey_array_join_without_indexed_prototype(
        &self,
        id: ObjectId,
        length: usize,
        separator: &str,
    ...
    pub(super) fn holey_array_slice_without_indexed_prototype(
        &mut self,
        id: ObjectId,
        length: usize,
        start: usize,
    ...
    pub(super) fn holey_concat_array_prefix_without_indexed_prototype(
        &mut self,
        result_id: ObjectId,
        start_index: usize,
        source_id: ObjectId,
...
pub(super) struct ArrayCopyLimits {
    max_objects: usize,
    max_properties: usize,
}

impl ArrayCopyLimits {
    pub(super) const fn new(max_objects: usize, max_properties: usize) -> Self {
        Self {
            max_objects,
            max_properties,
        }
